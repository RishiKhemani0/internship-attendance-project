...
$sql = "SELECT * FROM attendance WHERE employee_id = ? $whereClause ORDER BY $sort $order";
$stmt = $conn->prepare($sql);
...
<body class="bg-gray-200 dark:bg-gray-900 text-gray-800 dark:text-gray-100 font-sans transition-all duration-300">
